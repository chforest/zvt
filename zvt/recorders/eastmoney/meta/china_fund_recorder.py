...
from zvt.domain import Future, Index, Fund
...
fund_columns = ['id', 'entity_id', 'timestamp', 'entity_type', 'exchange', 'code', 'name', 'list_date', 'end_date']
funds = [
    # '161005', '110011', '162605', '163415', '163406', '163402', '163417'
    ['fund_cn_007119', 'fund_cn_161005', '2021-01-04 08:00:00', 'fund', 'cn', '007119', '睿远成长价值混合A', '2021-05-24 08:00:00', None],
    ['fund_cn_161005', 'fund_cn_161005', '2021-01-04 08:00:00', 'fund', 'cn', '161005', '富国天惠成长混合A/B', '2021-05-24 08:00:00', None],
    ['fund_cn_110011', 'fund_cn_110011', '2021-01-04 08:00:00', 'fund', 'cn', '110011', '易方达中小盘混合', '2021-05-24 08:00:00', None],
    ['fund_cn_162605', 'fund_cn_162605', '2021-01-04 08:00:00', 'fund', 'cn', '162605', '景顺长城鼎益混合', '2021-05-24 08:00:00', None],
    ['fund_cn_163415', 'fund_cn_163415', '2021-01-04 08:00:00', 'fund', 'cn', '163415', '兴全商业模式优选混合', '2021-05-24 08:00:00', None],
    ['fund_cn_163406', 'fund_cn_163406', '2021-01-04 08:00:00', 'fund', 'cn', '163406', '兴全合润混合', '2021-05-24 08:00:00', None],
    ['fund_cn_163402', 'fund_cn_163402', '2021-01-04 08:00:00', 'fund', 'cn', '163402', '兴全趋势投资混合', '2021-05-24 08:00:00', None],
    ['fund_cn_163417', 'fund_cn_163417', '2021-01-04 08:00:00', 'fund', 'cn', '163417', '兴全合宜混合', '2021-05-24 08:00:00', None],
]


class FundRecorder(Recorder):
    data_schema = Fund
    provider = 'eastmoney'

    def run(self):
        # 抓取Future列表，固定的方式
        df_future = pd.DataFrame(data=funds, columns=fund_columns)
        df_future['timestamp'] = pd.to_datetime(df_future['timestamp'])
        df_future['list_date'] = pd.to_datetime(df_future['list_date'])

        df_to_db(df_future, data_schema=Fund, provider=self.provider, force_update=True)

        self.logger.info("persist investing future list success")


__all__ = ['FundRecorder']
